...
FloatSlider* FloatSlider::create(char const* text, float defaultValue, float min, float max, std::function<FloatSlider::Callback>&& callback) {
...
bool FloatSlider::init(char const* text, float defaultValue, float min, float max, std::function<FloatSlider::Callback>&& callback) {
